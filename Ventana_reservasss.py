...
PRECIO_DE_ENTRADA:int=1800.0
cantidad:str= 'cantidad'
snacks:str= 'snacks'
movies:str = 'movies'

def obtener_informacion(objetivo)->dict:
...
def ventana_de_reservas()->None:
    
    lista_final = []
    boletos = {'disponibles': 5, 'totales': 10}
    comprar_boleto = {'cantidad': 0}
    informacion_snacks:dict = {'doritos': '2500.00', 
                               'popcorn_xl': '3000.00', 
                               'popcorn_xxl': '4300.00', 
                               'papas_fritas': '1800.00', 
                               'coca_cola_xl': '1500.00', 
                               'coca_cola_xxl': '2350.00', 
                               'chocolate 250g': '1100.00'} # obtener_snacks(snacks) después volver a acitivarlo
...
def crear_qr(informacion_de_compra:dict, archivos_compras)->None:
    #{'pelicula': '...', ubicacion: '...', }
    codigo:str = 'QR_' + str(len(archivos_compras))
    pelicula:str = ''
    ubicacion:str = ''
    cant_entradas:str = ''
